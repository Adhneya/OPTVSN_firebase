...
const serviceOfferings = [
  {
    ...
    description:
      "1:1 mentorship designed for aspiring and mid-career PMs to transition into leadership roles.",
  ...
  },
  {
    ...
    description:
      "Custom 2-day workshops for organizations, designed to align teams and transform feature-factory thinking into strategic leadership.",
  ...
  },
  {
    ...
    description:
      "Helping professionals from engineering, design, or business backgrounds break into product management with confidence.",
  ...
  },
  {
    ...
    description:
      "Focused modules on Agile, AI/ML PM concepts, case studies, and leadership drills to sharpen specific skills.",
...
const whoWeHelp = [
  {
    ...
    summary:
      "Transitioning to a PM role is as much about mindset as it is about skills. Learn how to think and act like a PM.",
    features: [
    ...
    offerings:
      "Individual PM 101 Training, 1-on-1 Mentorship, Hands-on Case Study",
  },
  {
    title: "Mid-Career PMs",
    headline: "Elevate from Tactical to Strategic PM",
    summary:
      "Move beyond execution and position yourself as a strategic leader.",
    features: [
    ...
    offerings:
      "Individual PM Training, 1-on-1 Mentorship, Mock Interviews, Resume Review",
  },
  {
...
const howItWorks = [
  {
    ...
    description: "A free 15-min call to understand your goals.",
  },
  {
    icon: Map,
    title: "Personalized Roadmap",
    description: "We craft a tailored plan to fit your specific needs.",
  },
  {
    icon: Users,
    title: "Coaching / Workshops",
    description: "Engage in hands-on, expert-led sessions.",
  },
  {
    icon: CheckCircle,
    title: "Career Success",
    description: "Achieve your goals and land your dream role.",
  },
];
...
const programTiers = [
  {
    name: "Starter",
    description: "For Aspiring PMs",
    href: "/programs#pm-launchpad-cohort",
  },
  {
    name: "Pro",
    description: "For Mid-Career PMs",
    href: "/programs#complete-pm-package",
  },
  {
    name: "Enterprise",
...
export default function ServicesPage() {
  ...
  const successStory2 = testimonials.find(
    (t) => t.company === "High-Growth Startup"
  );
  ...
  return (
    <>
      <main>
        ...
        <section className="relative bg-gradient-to-br from-primary/10 via-background to-background py-16 sm:py-24 text-center">
          <div className="container mx-auto max-w-4xl px-4">
            ...
            <p className="mt-6 max-w-3xl mx-auto text-lg text-muted-foreground">
              Our coaching and training programs are designed to help
              individuals and organizations unlock their full potential in
              Product Management.
            </p>
            <div className="mt-8">
        ...
        <section className="py-16 sm:py-24 bg-secondary">
          <div className="container mx-auto max-w-7xl px-4 text-center">
            <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl mb-12">
              How It Works
            </h2>
          ...
          <div className="container mx-auto max-w-4xl px-4">
            <div className="bg-secondary rounded-lg p-8 md:p-12 text-center shadow-lg">
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                Talk to our advisors and get a personalized recommendation.
              </p>
              <div className="mt-8">
                <Button
                  size="lg"
      ...
      <ContactModal
        ...
        defaultSubject="Free Discovery Call"
      />
    </>
  );
}
