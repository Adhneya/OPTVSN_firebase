...
export default function ProgramsOverview() {
  const overviewPrograms = pricingPlans.filter(p => ['PM End-to-End Transformation Package', 'Job Ready PM Package', 'Strategic PM Training', 'Technical PM Training', 'PM Mastery', 'Corporate Training'].includes(p.name));
