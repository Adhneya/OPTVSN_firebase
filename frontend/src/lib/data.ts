...
export const pricingPlans = [
  {
    name: 'PM End-to-End Transformation Package',
    tagline: 'From 0 to Job-Ready in 12-16 weeks — A Full Career Transformation',
    ideal_for: 'Ideal for: Aspiring PMs & career switchers.',
    prices: {
      inr: '₹29,999',
      usd: '$699',
      gbp: '£599',
    ...
    features: [
      '22 Live 1-on-1 Sessions (Strategy, Technical, Job Prep)',
      'Resume & LinkedIn Rewrite + Notion Portfolio',
      '3 Hands-On Case Studies (Choose 2 live + 1 simulation)',
      '25-Case Study Handout PDF + Interview Frameworks',
      'Personalized Templates, Action Plans & Feedback',
    ],
    cta: 'Enroll in PM End-to-End Transformation Package',
    comparison: {
...
cta: 'Enroll in Strategic PM Training',
  ...
  {
    name: 'Case Study Hands-On Package',
  ...
  {
    name: 'PM Mastery',
    tagline: 'Skill Up in 8 Weeks with Peer Learning & Expert Coaching',
    ideal_for: 'Ideal for: Beginners who prefer a group learning environment.',
    prices: {
      inr: '₹10,999/person',
      usd: '$250/person',
      gbp: '£200/person',
    ...
    features: [
        '8 Live PM Training Sessions',
        'Topics: Vision, OKRs, Personas, Prioritization, Launch Planning',
        'Cohort Vibes: Peer Networking + Review Sessions',
        'PM Templates + WhatsApp Group Support',
        'Certificate + LinkedIn Shoutout',
    ],
    cta: 'Join PM Mastery',
    comparison: {
        duration: "8 weeks",
